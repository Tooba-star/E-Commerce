            ...
            <div className="container-fluid pt-5 bg-footer">
                            ...
                            <div className="footer-list-div">
                                ...
                                <ul>
                                    <li className="pb-3">
                                        ...
                                        <span>+92 3118968799</span>
                                    </li>
                                    <li className="pb-3">
                                        <span className="bg-warning p-2 rounded mr-3">
                                            <FontAwesomeIcon icon="envelope" className="text-white" />
                                        </span>
                                        <span>toobaanwer32@gmail.com</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="col-12 footer-copyright">
                        <p>© 2021 A's Food. All Rights Reserved. Powered By <span style={{ color: "#eb6825", fontWeight: 700 }}>Tooba Anwer</span></p>
                    </div>
                </div>
            </div>
        );
